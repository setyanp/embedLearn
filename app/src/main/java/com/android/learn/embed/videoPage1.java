...
public class videoPage1 extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, OnClickListener {
    ...
    public void onInitializationSuccess(Provider provider, YouTubePlayer player, boolean wasRestored) {
        if (!wasRestored) {
            player.cueVideo("qU76yWHeQuw"); // Plays https://www.youtube.com/watch?v=fhWaJi1Hsfo
        }
    }
